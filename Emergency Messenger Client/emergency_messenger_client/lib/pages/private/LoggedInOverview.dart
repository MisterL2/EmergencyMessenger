...
class LoggedInOverviewState extends DynamicPrivateState<LoggedInOverview> {
  ...
  Future<void> loadDynamicContent() async {
    ...
    await dbHandler.addMessage(1, "TestData message 1", 1583070543, true);
    ...
    await dbHandler.addMessage(2, "TestData message 2", 1583070543, true);
    ...
    await dbHandler.addMessage(3, "TestData message 3", 1583070543, true);
    ...
    await dbHandler.addMessage(4, "Outgoing message 4", 1583070543, false);
    ...
    await dbHandler.addMessage(5, "TestData message 5", 1583070543, true);
    ...
    await dbHandler.addMessage(6, "TestData message 6", 1583070543, true);
    ...
    await dbHandler.addMessage(7, "TestData message 7", 1583070543, false);
    ...
    await dbHandler.addMessage(8, "TestData message 8", 1583070543, true);
    ...
    await dbHandler.addMessage(9, "TestData message 9", 1583070543, false);
    ...
    await dbHandler.addMessage(10, "TestData message 10", 1583070543, true);
    //End of Test data
